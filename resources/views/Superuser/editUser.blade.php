...
@section('content')
<admin-container-component role="{{auth()->user()->role}}" authname="{{auth()->user()->name}}" nav="Edit Fisherman Profile">
<a href="/admin">Back</a>
@if(session()->has('message'))
    ...
    @endif
<form method="POST" action="/user/{{$data->id}}" class="justify-content-center d-flex">
        @csrf
        @method('PUT')
            <div class="container w-100">
                    <div class="row">
                        ...
                        <div class="col">
                            <div>
                                <label class="font-weight-bold mt-2 mb-2" for="username">Username</label>
                            </div>
                            <div>
                                <input  type="text" id="username" class="form-control-lg w-100 border border-secondary bg-transparent"  value="{{$data->username}}" name="username" required autofocus />
                            </div>
                            @error('username')
                                <div class="pt-2 text-danger font-weight-bold mt-2 mb-2">{{$message}}</div>
                            @enderror
                   ...
                   <div class="row">
                       <div class="col">
                           <div>
                               <label class="font-weight-bold mt-2 mb-2" for="address">Address</label>
                            </div>
                            <div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div>
                               <label class="font-weight-bold mt-2 mb-2" for="barangay">Barangay</label>
                            </div>
                            <div>
                        ...
                        <div class="col">
                            <div>
                                <label class="font-weight-bold mt-2 mb-2" for="phone_number">Phone Number</label>
                            </div>
                            <div>
