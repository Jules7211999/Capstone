...
@section('content')
<admin-container-component role="{{auth()->user()->role}}" authname="{{auth()->user()->name}}" nav="Update Fisherman Profile">
<a href="/admin">Back</a>
        ...
        <div class="container w-100">
                   ...
                   <dropdown-barangay-component/>
                    ...
                    <div class="row">
                        ...
                        <div>
                            <select class="font-weight-bold form-control-lg w-100 border bg-transparent"  value="{{$data->gender}}" id="inlineFormCustomSelect" name="gender">
