            ...
            <div class="row w-100 justify-content-center">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div>
                                <input  type="text" id="name" class="form-control-lg w-100 border  bg-transparent"  name="name" required autofocus />
                            </div>
                                @error('name')
                        ...
                        <div class="col">
                            ...
                            <div>
                                <input  type="text" id="email" class="form-control-lg w-100 border  bg-transparent"  name="email" required autofocus />
                            </div>
                                @error('email')
                                    <div class="pt-2 text-danger font-weight-bold mt-2 mb-2">{{$message}}</div>
                                @enderror
