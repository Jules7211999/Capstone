    ...
    @if ($errors->any())
        ...
        <form method="POST" action="{{ route('password.update') }}">
            ...
            <div class="text-left text-dark">
                ...
                <input id="email" class="form-control-lg w-100  bg-light" type="email" name="email" value="{{$request->email}}" required autofocus />
            </div>

            <!-- Password -->
            <div class="text-left text-dark">
               <label class="font-weight-bold" for="password">Password</label>
                <input id="password" class="form-control-lg w-100  bg-light" type="password" name="password" required />
            </div>
