...
<div class="w-100 h-100">
    ...
    <div v-for="d in waiting" class="d-flex justify-content-center align-items-center w-100 mb-2 ">
            <div v-if="d.user.barangay_id == barangay || barangay == ''" class=" p-4 row w-100 rounded font-weight-bold text-danger shadow-sm border ml-1">
   ...
   <div v-for="d in processing" class="d-flex justify-content-center align-items-center  w-100 mb-2 ">
            <div  v-if="d.user.barangay_id == barangay || barangay == ''" class=" p-4 row w-100 rounded font-weight-bold text-primary shadow-sm border ml-1 ">
     ...
     <div v-for="d in done" class="d-flex justify-content-center w-100 mb-2 ">
            <div  v-if="d.user.barangay_id == barangay || barangay == ''" class=" p-4 row w-100 rounded font-weight-bold text-success shadow-sm border ml-1 ">
     ...
     <div v-for="d in cancel" class="d-flex justify-content-center w-100 mb-2 ">
            <div  v-if="d.user.barangay_id == barangay || barangay == ''" class=" p-4 row w-100 rounded font-weight-bold text-secondary shadow-sm border ml-1 ">
                <div  class="col"><a :href="'/emergency/'+d.id" class="text-secondary">{{d.id}}</a></div>
                    <div  class="col"><a :href="'/emergency/'+d.id" class="text-secondary">{{d.user.name}}</a></div>
                    <div class="col">{{d.type}}</div>
                    <div class="col">{{d.status}}</div>
                    <div class="col">{{d.datetimezone}}</div>
                    <div class="col"></div>
